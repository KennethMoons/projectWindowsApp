...
namespace ProjectOpendeurdag
{
    ...
    /// </summary>
    public sealed partial class InfomomentfeedDetail : Page
    {
        private Infomoment infomoment;
        public InfomomentfeedDetail()
        {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                if (o.OpleidingId == infomoment.OpleidingId)
                {
            ...
            {
                if (c.CampusId == infomoment.CampusId)
                {
                    campus.Text = c.Naam;
                }
            }
        ...
        private async void reminder_button_Click(object sender, RoutedEventArgs e)
        {
            ...
            if ((int)result.Id == 0)
            {
                ...
                toast.TextHeading.Text = infomoment.Titel; ;
                toast.TextBodyWrap.Text = infomoment.Beschrijving;
